...
const MeetingMod = require("./meeting.js");
...
let MeetingModule = new MeetingMod();
...
client.on("message", (msg) => {
  ...
  if (msg.guild) {
    ...
    if (valid) {
      ...
      MeetingModule.onMessage(msg, g_db);
...
var secret = JSON.parse(
  fs.readFileSync("secret.json", "utf8").toString().trim()
);
